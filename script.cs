...
string auditDir = @"c:\Users\ajayb\UzhavarHub\research_audit";
Directory.CreateDirectory(auditDir);

File.WriteAllText(Path.Combine(auditDir, "01_project_architecture.md"), @"# Project Architecture Audit
...
File.WriteAllText(Path.Combine(auditDir, "02_data_inventory.md"), @"# Data Inventory Audit
...
File.WriteAllText(Path.Combine(auditDir, "03_model_inventory.md"), @"# Model Inventory Audit
...
File.WriteAllText(Path.Combine(auditDir, "04_experiment_inventory.md"), @"# Experiment Inventory Audit
...
File.WriteAllText(Path.Combine(auditDir, "05_reproducibility_audit.md"), @"# Reproducibility Audit
...
File.WriteAllText(Path.Combine(auditDir, "06_methodology_audit.md"), @"# Methodology Audit
...
File.WriteAllText(Path.Combine(auditDir, "07_q1_reviewer_audit.md"), @"# Q1 Reviewer Audit
...
File.WriteAllText(Path.Combine(auditDir, "08_claim_evidence_matrix.csv"), @"Claim,Source,Dataset,Model,Experiment,Metric,Actual Result,Real/Synthetic,Reproducible,Statistically Supported,Q1 Risk Level
...
File.WriteAllText(Path.Combine(auditDir, "09_problem_priority_matrix.csv"), @"Problem,Category,Priority,Description,Action
...
File.WriteAllText(Path.Combine(auditDir, "10_current_q1_readiness.md"), @"# Current Q1 Readiness
...
Console.WriteLine("Audit files generated successfully.");
